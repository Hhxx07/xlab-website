...
INSERT INTO articles (id, user_id, title, slug, body, summary, word_count, published) VALUES (
    ...
    '电路分析：基尔霍夫定律入门',
    'knowledge-kirchhoff',
    '# 电路分析：基尔霍夫定律入门KCL 和 KVL 是电路分析的两大基石。## KCL — 基尔霍夫电流定律**流入节点的电流 = 流出节点的电流。**本质是电荷守恒：电荷不会凭空消失或产生。在任意节点处，所有支路电流的代数和为零。\n\n## KVL — 基尔霍夫电压定律\n\n**任意闭合回路中，电压降的代数和为零。**\n\n本质是能量守恒：绕一圈回到出发点，电势不变。\n\n## 节点电压法\n\n1. 选定参考节点（地）\n2. 对每个非参考节点列 KCL 方程\n3. 用节点电压表示各支路电流\n4. 解方程组\n\n这是最实用的电路分析方法之一。',
...
INSERT INTO articles (id, user_id, title, slug, body, summary, word_count, published) VALUES (
    ...
    '黑神话：悟空 — 玩法深度体验',
    'game-black-myth',
    '# 黑神话：悟空 — 玩法深度体验从战斗系统到关卡设计，聊聊《黑神话：悟空》带来的惊喜与思考。## 战斗系统的精妙三段棍势 + 定身术 + 分身术的组合，让每一场 Boss 战都像在解谜。- **劈棍**：高伤害，适合 Boss 硬直窗口- **立棍**：防御反击，适合不熟悉敌人出招时\n- **戳棍**：远程消耗，安全但伤害较低\n\n三种棍势的切换时机决定战斗节奏。\n\n## 关卡设计\n\n线性与半开放世界的平衡做得很好。不会迷路，但也不会觉得被牵着走。每个章节都有独特的视觉主题——黄风岭的沙漠、紫云山的竹林、火焰山的熔岩。\n\n## 不足之处\n\n空气墙问题确实存在，有些看起来能跳过去的地方其实是透明的墙。希望后续更新能改善。',
